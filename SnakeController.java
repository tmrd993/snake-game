...
public class SnakeController implements KeyListener {
	...
	// moving left from starting position would reverse the direction which is not
	// allowed
	if (key == KeyEvent.VK_LEFT && !(snakeModel.getDirection() == SnakeGameModel.Direction.Right)
		&& !(snakeModel.getDirection() == SnakeGameModel.Direction.None)) {
